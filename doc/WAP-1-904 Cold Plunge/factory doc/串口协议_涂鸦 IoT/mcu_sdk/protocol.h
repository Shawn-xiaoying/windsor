...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "ft8pgw4qn4xerqul"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//水流传感器2(只上报)
//备注:水流传感器2 
#define DPID_WATER_SWITCH_STATE_2 101
//水流量(只上报)
//备注:
#define DPID_WATER_FLOW 106
//电源开关(可下发可上报)
//备注:
#define DPID_POWER_SWITCH 108
//目标温度(可下发可上报)
//备注:
#define DPID_TEMP_SET_F 109
//声音(可下发可上报)
//备注:
#define DPID_SOUND_SWICH 110
//温度单位(可下发可上报)
//备注:
#define DPID_TEMP_UINT 111
//臭氧阀开启时间(可下发可上报)
//备注:
#define DPID_OZONE_TIME 112
//上电开机(可下发可上报)
//备注:
#define DPID_POWER_ON_ENABLE 116
//水流传感器(只上报)
//备注:
#define DPID_WATER_SWITCH_STATE 129
//当前温度(只上报)
//备注:
#define DPID_TEMP_CURRENT_F 137
