...
#define BLUETOOTH_NOT_CONNECTED 0x02
#define BLUETOOTH_CONNECTED 0x03
#define BLUETOOTH_CONN_CLOUD 0x04
#define BLUETOOTH_LOW_POWER 0x05
#define SMART_AND_AP_STATE 0x06
#define BLUETOOTH_SATE_UNKNOW 0xff
//=============================================================================
// bluetooth配网的方式
//=============================================================================
...
// bluetooth复位状态
//=============================================================================
#define RESET_BLUETOOTH_ERROR 0
#define RESET_BLUETOOTH_SUCCESS 1

//=============================================================================
// bluetooth配置复位状态
//=============================================================================
#define SET_BLUETOOTHCONFIG_ERROR 0
#define SET_BLUETOOTHCONFIG_SUCCESS 1

//=============================================================================
// MCU固件升级状态
//=============================================================================
#define FIRM_STATE_UN_SUPPORT 0x00         // 不支持 MCU 升级
#define FIRM_STATE_BLUETOOTH_UN_READY 0x01 // 模块未就绪
...
// BLUETOOTH和mcu的工作方式
//=============================================================================
#define UNION_WORK 0x0      // mcu模块与bluetooth配合处理
#define BLUETOOTH_ALONE 0x1 // bluetooth模块自处理
