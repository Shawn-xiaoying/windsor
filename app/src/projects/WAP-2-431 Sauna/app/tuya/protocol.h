...
#else
#define BLUETOOTH_UART_RECV_BUF_LMT 256 // 串口数据接收缓存区大小,如MCU的RAM不够,可缩小

// 请在此处选择合适的串口数据处理缓存大小（根据上面MCU固件升级包选择的大小和是否开启天气服务来选择开启多大的缓存）
#define BLUETOOTH_DATA_PROCESS_LMT 300  // 串口数据处理缓存大小,如需MCU固件升级,若单包大小选择256,则缓存必须大于260,若开启天气服务,则需要更大
...
#define DPID_POWER_SWITCH 101
#define DPID_HEAT_SWITCH 102
#define DPID_TIME_SET 103
#define DPID_TEMP_C_SET 104
#define DPID_TEM_CHANGE 105
#define DPID_TIMING_SWITCH 106
#define DPID_LIGHT_SWITCH1 107
#define DPID_LIGHT_SWITCH2 108
#define DPID_HEATING_DISPLAY 109
// LED氛围灯调节(可下发可上报)
// 备注:类型：基于“经典颜色”的HSV颜色编码。字符； Value:000011112222；H:0000,S:1111;S:2222。颜色编码：白色：HSV:H-0X0000  S-0X0000  V-0X0064; 红色：HSV:H-0X0000   S-0X0064  V-0X0064;绿色：HSV:H-0X0078  S-0X0064   V-0X0064; 蓝色：HSV:H-0X00F0   S-0X0064  V-0X0064; 橙色：HSV:H-0X0027   S-0X0064  V-0X0064;  黄色：HSV:H- 0X003C   S-0X0064  V-0X0064;  粉红色：HSV:V-0X012C    S-0X0064  V-0X0064。注：实际调色时，观感可能有些差异，经实样测试后再微调
#define DPID_LIGHT_COLOR 110

// 华氏温度设置
#define DPID_TEMP_SET 111
#define DPID_MEDIA_SWITCH 112
#define DPID_FAN_SWITCH 113
#define DPID_INDOOR_TEM 114
#define DPID_COLOR_SWITCH 115
#define DPID_COLOR_CHANGE_SWITCH 116
#define DPID_HEATING_RESERVATION 117 // heating_reservation 117
#define DPID_TEMP_DISPLAY 119

#define DPID_HEAT1_POWER 120
#define DPID_HEAT2_POWER 121
#define DPID_HEAT3_POWER 122
