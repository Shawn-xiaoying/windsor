...
typedef enum {
	CMD_STATUS_NONE,
	CMD_STATUS_START, //start sending
	CMD_STATUS_SEND_IN, //send in
	CMD_STATUS_TIMEOUT, //response timeout
	CMD_STATUS_ACK_CHECK_ERROR, // check error
	CMD_STATUS_OK
...
SYSTEM_EXTERN  volatile  SEND_CMD_STATUS send_cmd_state ;
SYSTEM_EXTERN  volatile  cmd_data_description current_cmd_data ;
