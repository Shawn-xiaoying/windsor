...
//    unsigned char index = 0;
    ...
    //
    //    send_len = set_bluetooth_uart_byte(send_len, send_len>>8);
    //    send_len = set_bluetooth_uart_byte(send_len, send_len&0xff);
    //
    //    if (value == FALSE)
    //    {
    ...
    send_len = set_bluetooth_uart_byte(send_len, len % 0x100);
    //
    send_len = set_bluetooth_uart_buffer(send_len, value, len);
