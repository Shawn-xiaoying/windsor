...
#define EFSM_REG_STATE(OBJ, STATE) (Efsm_RegState((OBJ), (efsmState_t)(STATE))) // 为当前对象注册state
#define EFSM_EVT_TRIG(OBJ, EVT) (Efsm_EvtTrig((OBJ), (EVT)))                    // 为当前对象发送事件
#define EFSM_TRANS(OBJ, STATE) (Efsm_Trans((OBJ), (efsmState_t)(STATE)))        // 为当前对象切换状态
