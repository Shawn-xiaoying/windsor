...
// #define SERIAL_RX_OVER_TIME     APP_TIMER_TICKS(6) /**< 串口接收数据完成延时 */
...
static void mt_uart_event_handle(app_uart_evt_t *p_event)
{
    ...
    case APP_UART_COMMUNICATION_ERROR:
        // NRF_LOG_WARNING("uart communication error");
        break;

    case APP_UART_FIFO_ERROR:
        NRF_LOG_WARNING("uart fifo error");
...
void mt_serial_ctrl_handler(bool ctrl)
{
    ...
    nrf_gpio_cfg_default(UART_RX_PIN);
