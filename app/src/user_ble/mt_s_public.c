...
uint32_t common_char_add(uint8_t uuid_type,
                         ...
                         uint16_t uuid)
{
    ble_gatts_char_md_t char_md; // ��������Ҫ���õ����Բ���������������ԣ�Ҳ�������ݴ���Ŀ������ԣ�����һЩ�����������Ƿ���Ҫʹ�����������������Ĵ�С�ȵ�
    ...
    char_md.char_props.notify = char_props.notify;               // ����֪ͨ
    char_md.char_props.write = char_props.write;                 // ����д������������д������������д��ֵ
    char_md.char_props.read = char_props.read;                   // ���ö�����
    char_md.char_props.write_wo_resp = char_props.write_wo_resp; // ����д���޻�Ӧ��ֵ
    char_md.char_props.indicate = char_props.indicate;           // ����ָʾ��ֵ
    char_md.p_char_user_desc = NULL;
    char_md.p_char_pf = NULL;
    char_md.p_user_desc_md = NULL;
    char_md.p_cccd_md = &cccd_md; /*�ͻ�����������������������Ԫ����  */
